            ...
            for KernelNumb in range(kStart, kMax + 1, 1):
                ...
                for n in range(NStart, NMax + NStep, NStep):
                    ...
                    for a in range(0, len(overlapingSide), 1):
                        ...
                        # Direita (label é o primeiro, ovelapping à direita)
                        if overlapingSide[a] == 0:
                            for k in range(numberSubjectsN + 1):
                                if k < 11:  # NOTE: Because there is no subject with number 12
                                    dataName = "n" + str(k + 1)
                                    labName = "nc" + str(k + 1)
                        ...
                        # Centro (label no centro, ovelapping à esquerda + direita)
                        ...
                        # Esquerda (label é o último, ovelapping à esquerda)
                        else:
                            for k in range(numberSubjectsN + 1):
                                if k < 11:
                                    dataName = "n" + str(k + 1)
