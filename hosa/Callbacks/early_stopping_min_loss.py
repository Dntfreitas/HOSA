...
class EarlyStoppingAtMinLoss(tf.keras.callbacks.Callback):
    ...
    def __init__(self, class_model, patience, validation_data, imbalance_correction=False, rtol=1e-03, atol=1e-04):
        ...
        Args:
            class_model: Class of the object to be optimized. Available options are: :class:`.RNNClassification`, :class:`.RNNRegression`, :class:`.CNNClassification` and :class:`.CNNRegression`.
            ...
            rtol (float): The relative tolerance parameter, as used in `numpy.isclose`. See `numpy.isclose <https://numpy.org/doc/stable/reference/generated/numpy.isclose.html>`_.
            atol (float): The absolute tolerance parameter, as used in `numpy.isclose`. See `numpy.isclose <https://numpy.org/doc/stable/reference/generated/numpy.isclose.html>`_.
        """
        super().__init__()
        self.class_model = class_model
        self.model, self.patience, self.imbalance_correction = self.class_model.model, patience, imbalance_correction
    ...
    def on_epoch_end(self, epoch, logs=None):
        current_metric, *_ = self.class_model.score(self.X_validation, self.y_validation, imbalance_correction=self.imbalance_correction)
